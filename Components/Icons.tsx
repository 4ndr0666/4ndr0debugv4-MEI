...
export const ReportIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <title>Adversarial Report</title>
...
export const CrosshairsIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <title>Threat Vector</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-2m0-14V3m9 9h2m-14 0H3m16.036-7.036L19.62 5.38m-14.24 0l1.414 1.414M5.38 18.62l1.414-1.414m11.828 0l-1.414-1.414" />
...
export const LogoIcon = ({ className }: { className?: string }) => (
    <svg 
        ...
        aria-label="4ndr0debug logo"
    >
        <title>4ndr0debug Logo</title>
...
export const ToastInfoIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const CompareIconSvg = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <title>Compare</title>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 16V4m0 12L3 8m4 4l4-8m4 12V4m0 12l4-8m-4 8l-4-8" />
    </svg>
);
...
export const RootCauseIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <title>Analyze Root Cause</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.375 3.375 0 0014 18.442V19.5a.5.5 0 01-.5.5h-3a.5.5 0 01-.5-.5v-1.058a3.375 3.375 0 00-.913-2.312l-.547-.547z" />
    </svg>
);

export const LoadIntoEditorIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <title>Load into Editor</title>
